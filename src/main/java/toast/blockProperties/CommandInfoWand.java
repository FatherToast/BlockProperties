...
public class CommandInfoWand extends CommandBase {
    ...
    public String getCommandUsage(ICommandSender sender) {
        return "/bpinfo <player> - gives a stick that writes nbt data to a file in bp\'s nbt function format.";
    }
    ...
    public void processCommand(ICommandSender sender, String[] args) {
        ...
        infoWand.setStackDisplayName("\u00a7bBP Info Wand");
        ...
        infoWand.stackTagCompound.setBoolean("BP|InfoWand", true); // Actually makes the item work

        EntityItem drop = player.dropPlayerItemWithRandomChoice(infoWand, false);
        drop.delayBeforeCanPickup = 0;

        sender.addChatMessage(new ChatComponentText("Right click a block or mob with this to write its data to a file."));
    }
}
